...
{
    return [NSEntityDescription insertNewObjectForEntityForName:@"CfeLevelThree" inManagedObjectContext:a_context];
}
...
+ (CfeLevelThree *)createCfeLevelThreeInContext:(NSManagedObjectContext *)a_context
    ...
    CfeLevelThree *_levelThree;
    NSError *_savingError = nil;
    _levelThree = [CfeLevelThree createCfeLevelThreeInContext:a_context];
    if(_levelThree == nil){
        NSLog(@"");
    }
