...
{
    return [NSEntityDescription insertNewObjectForEntityForName:@"CfeLevelTwo" inManagedObjectContext:a_context];
}
...
+ (CfeLevelTwo *)createCfeLevelTwoInContext:(NSManagedObjectContext *)a_context
    ...
    CfeLevelTwo *_levelTwo;
    NSError *_savingError = nil;
    _levelTwo = [CfeLevelTwo createCfeLevelTwoInContext:a_context];
    if(_levelTwo == nil){
        NSLog(@"");
    }
