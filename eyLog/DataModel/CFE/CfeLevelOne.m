...
+ (CfeLevelOne *)createCfeLevelOneInContext:(NSManagedObjectContext *)a_context{
    return [NSEntityDescription insertNewObjectForEntityForName:@"CfeLevelOne" inManagedObjectContext:a_context];
}
+ (CfeLevelOne *)createCfeLevelOneInContext:(NSManagedObjectContext *)a_context
    ...
    CfeLevelOne *_levelOne;
    NSError *_savingError = nil;
    _levelOne = [CfeLevelOne createCfeLevelOneInContext:a_context];
