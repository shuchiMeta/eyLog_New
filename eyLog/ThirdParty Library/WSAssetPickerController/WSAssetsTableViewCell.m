...
@property (strong, nonatomic) NSArray *assetsForCell;
@end
...
- (void)layoutSubviews
{
    ...
    __block CGRect frame = ASSET_VIEW_FRAME;
    [self.cellAssetViews enumerateObjectsUsingBlock:^(WSAssetViewColumn *assetView, NSUInteger idx, BOOL *stop) {
...
//        WSAssetWrapper *assetWrapper = [self.assetsForCell objectAtIndex:idx];
//        if ([[assetWrapper.asset valueForProperty:ALAssetPropertyType] isEqualToString:ALAssetTypeVideo]) {
//            UIImageView *view = [[UIImageView alloc] initWithFrame:assetView.frame];
//            [view setImage:[UIImage imageNamed:@"play"]];
//            [assetView bringSubviewToFront:view];
//            [assetView addSubview:view];
//        }
